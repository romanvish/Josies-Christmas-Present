...
// function spanClass(span?: ProjectMedia["span"]) {
//   switch (span) {
//     case "tall":
...
export function ProjectPagePlayground({ title, subtitle, summary, heroMedia, heroBackground, story, details, images }: ProjectPageProps) {
